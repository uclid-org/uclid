...
A simple \uclid{} module that computes the Fibonacci sequence is shown in Example~\ref{ex:fib-model}.  Let us walk through each line in this model to understand the basics of \uclid{}.
...
\end{comment}
  ...
  \codelike{\$ export PATH=\$PATH:\$PWD/uclid-0.9/bin/}
...
Invoke \uclid{} on a model is easy. Just run the \codelike{uclid} binary and provide the model as a command-line argument.
...
Hopefully, this chapter has provided an flavor of \uclid{}'s features and an introduction of how to use the \uclid{} toolchain. The rest of this tutorial will take a more detailed looked at more of \uclid{}'s features.
