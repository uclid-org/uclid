...
The \keywordbf{init} block appears next and spans lines 5 to 8. It defines the initial values of the state variables in the module. We see that \ident{a} is initialized to 0 while \ident{b} is initialized to 1.
