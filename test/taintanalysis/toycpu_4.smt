...
(declare-var sel1 (_ BitVec 2))
(declare-var sel2 (_ BitVec 2))
(declare-var sel3 (_ BitVec 2))
(declare-var sel4 (_ BitVec 2))
(rule (! (let ((a!1 
                   (! (or (not (select D
                                       (_tuple_0 sel1
                                                 C
...
(query error_next_hyp_assert_0 :print-answer true)
