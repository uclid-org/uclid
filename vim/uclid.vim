...
syn keyword ucl4Decl            module init next control function procedure returns call type var input output const property invariant synthesis grammar requires ensures instance axiom in
